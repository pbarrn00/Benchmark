...
void blancoYnegro::setTimeLineEdit(int i, double milisec)
{
    switch (i) {
        ...
        case 0:
            ui->lineEdit_7->setText(QString::number(milisec)+" ms");
            break;
        case 1:
            ui->lineEdit_9->setText(QString::number(milisec)+" ms");
            break;
        case 2:
            ui->lineEdit_8->setText(QString::number(milisec)+" ms");
            break;
        case 3:
            ui->lineEdit_10->setText(QString::number(milisec)+" ms");
            break;
        case 4:
            ui->lineEdit_11->setText(QString::number(milisec)+" ms");
            break;
    }
}
...
void blancoYnegro::setAverageTime()
{
    ...
    ui->lineEdit_12->setText(QString::number(average)+" ms");
}
